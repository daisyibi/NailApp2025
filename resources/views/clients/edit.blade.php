                ...
                <form action="{{ route('clients.update', $client) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        @if($client->image)
                            <div class="mt-4 text-center">
                                ...
                                <img src="{{ asset('images/clients/' . $client->image) }}" 
                                     alt="{{ $client->name }}" 
                                     class="w-40 h-40 object-cover rounded-xl mx-auto border border-pink-200 shadow-md hover:scale-105 transition-transform">
                            </div>
                        @endif
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="w-full border border-pink-200 rounded-lg focus:border-pink-400 focus:ring-pink-300 resize-none p-3 text-gray-700">{{ $client->notes }}</textarea>
                    </div>
