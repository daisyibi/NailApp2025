                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input type="text" name="design_choice" field="design_choice"
                                placeholder="e.g. French Tips, Chrome, Floral..." class="w-full border-pink-200 rounded-xl focus:border-pink-400 focus:ring-pink-300"
                        ...
                        <div>
                            ...
                            <select name="nailtechs[]" multiple
                                ...
                                @foreach($nailtechs as $tech)
                                    <option value="{{ $tech->id }}" {{ $client->nailtechs->contains($tech->id) ? 'selected' : '' }}>
                                        {{ $tech->name }}
                                    </option>
                                @endforeach
                            </select>
