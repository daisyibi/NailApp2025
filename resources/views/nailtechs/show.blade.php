            ...
            <div class="bg-white/95 backdrop-blur-lg border border-pink-200 shadow-3xl shadow-rose-300/60 sm:rounded-[2.5rem] p-8 md:p-12">
                ...
                <div class="flex flex-col lg:flex-row gap-10 items-stretch">
                    ...
                    <div class="flex-1 lg:w-2/3 space-y-8 font-sans">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div class="flex items-start text-lg text-gray-700 p-4 bg-pink-50 rounded-xl border border-pink-100 shadow-sm">
                                    <svg class="w-6 h-6 text-rose-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.146a.5.5 0 01.402 0l4 2.5a.5.5 0 01.076.064 1 1 0 00.12.083l4 2.5a.5.5 0 01.328.468V18.5a.5.5 0 01-.247.433l-4 2.5a.5.5 0 01-.524 0l-4-2.5a.5.5 0 01-.076-.064 1 1 0 00-.12-.083l-4-2.5a.5.5 0 01-.328-.468V5.5a.5.5 0 01.247-.433z"></path></svg>
                                    <div>
                                ...
                                <div class="flex items-start text-lg text-gray-700 p-4 bg-pink-50 rounded-xl border border-pink-100 shadow-sm">
                                    <svg class="w-6 h-6 text-rose-600 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c1.657 0 3 1.343 3 3v2a2 2 0 01-2 2H9a2 2 0 01-2-2v-2c0-1.657 1.343-3 3-3zM9 12h6m-3-4V4m0 16v-4"></path></svg>
                                    <div>
                        ...
                        <div class="pt-4">
                            <h4 class="text-2xl font-bold text-rose-800 mb-6 border-b border-pink-200 pb-2">Client Portfolio ({{ $nailtech->clients->count() }})</h4>
                                    ...
                                    @foreach($nailtech->clients as $client)
                                        <li class="bg-white rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-pink-100 p-4 flex flex-col md:flex-row justify-between items-start md:items-center">
                                            <div class="flex items-center">
                                                <svg class="w-5 h-5 text-pink-500 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                                                <div>
                                                    <p class="font-semibold text-gray-800 text-lg">{{ $client->name }}</p>
                                                    <p class="text-gray-600 text-sm">Last Design: <span class="font-medium">{{ $client->design_choice ?? '—' }}</span></p>
                                                </div>
                                            </div>
                    ...
                    <div class="lg:w-1/3 flex-shrink-0 flex justify-center lg:justify-end">
                        <div class="w-full max-w-xs h-72 rounded-[2rem] bg-gradient-to-br from-pink-300 to-rose-400 shadow-2xl shadow-rose-300/80 p-6 flex items-center justify-center border-4 border-white/50">
                            <div class="text-center text-white/90">
                                <svg class="w-20 h-20 mx-auto mb-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
